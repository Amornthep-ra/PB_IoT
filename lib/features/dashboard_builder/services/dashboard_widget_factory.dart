    ...
    switch (type) {
      case DashboardItemType.button:
        return DashboardItem(
          ...
          rect:
              ...
              const GridRect(x: 0, y: 0, w: 4, h: 4),
          minW: buttonMinW,
          maxW: buttonMaxW,
          minH: buttonMinH,
          maxH: buttonMaxH,
          accentColor: const Color(0xFF1F9443),
          secondaryAccentColor: const Color(0xFFE65A5A),
      ...
      case DashboardItemType.toggle:
        return DashboardItem(
          ...
          title: defaultTitle,
          titleColor: const Color(0xFF15212B),
          rect: const GridRect(x: 0, y: 0, w: 5, h: 3),
          minW: 5,
          maxW: 18,
          minH: 3,
          maxH: 8,
      ...
      case DashboardItemType.valueLabel:
        return DashboardItem(
          ...
          title: defaultTitle,
          titleColor: const Color(0xFF15212B),
          rect: const GridRect(x: 0, y: 0, w: 8, h: 3),
          minW: 8,
          maxW: 24,
          minH: 3,
          maxH: 14,
      ...
      case DashboardItemType.led:
        return DashboardItem(
          ...
          title: defaultTitle,
          titleColor: const Color(0xFF15212B),
          rect: const GridRect(x: 0, y: 0, w: 4, h: 4),
          minW: 4,
          maxW: 8,
          minH: 4,
          maxH: 8,
          accentColor: const Color(0xFF4ECB71),
          secondaryAccentColor: const Color.fromARGB(255, 255, 0, 0),
          value: 0,
          dataSource: 'device_channel',
          bindingMode: 'read',
          dataType: 'bool',
